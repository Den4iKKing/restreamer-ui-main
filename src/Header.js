...
function AboutModal(props) {
	...
	return (
		<Modal open={props.open} onClose={props.onClose} className="modal">
			<ModalContent title="About Comedoz Restreamer" onClose={props.onClose} className={classes.modalPaper}>
				<Grid container spacing={1}>
					...
					<Grid item xs={12}>
						<Typography variant="body1">
							...
							<Link color="secondary" href="https://www.youtube.com/@comedoz" target="_blank">
								Comedoz Core
							</Link>{' '}
					...
					<Grid item xs={12}>
						...
						<Typography>
							<strong>Repo</strong>:{' '}
							<Link color="secondary" target="_blank" href="https://www.youtube.com/@comedoz">
							https://www.youtube.com/@comedoz
							</Link>
						</Typography>
						<Typography>
			...
			<React.Fragment>
				...
				<StyledMenu anchorEl={$anchorEl} open={$anchorEl !== null} onClose={handleMenuClose} onClick={handleMenuClose} disableScrollLock>
					{props.hasService === true && (
						<React.Fragment>
							<MenuItem component="a" href="https://www.youtube.com/@comedoz" target="blank">
								<ListItemIcon>
